    ...
    <DashboardLayout title="Land Board Surveyors">
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-semibold text-slate-800">Land Board Surveyors</h3>
          ...
          <button onClick={openCreate}
            ...
            <Plus size={16} /> Add Land Board Surveyor
          </button>
        </div>

        {loading ? <TableSkeleton rows={4} /> : users.length === 0 ? (
          <p className="text-slate-500 text-sm">No Land Board Surveyors yet.</p>
        ) : (
      ...
      <Modal open={createOpen} onClose={() => setCreateOpen(false)} title="Add Land Board Surveyor">
      ...
      <Modal open={editOpen} onClose={() => setEditOpen(false)} title="Edit Land Board Surveyor">
