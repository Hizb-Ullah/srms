...
// status (the Lot Allocator's sign-off). The Lot Allocator's own views call
// this "Authorised" (their action) — but per client, the surveyor's own
// dashboard should call it "Approved" instead (their file's outcome).
// "Authorised" stays reserved for DSM-staff-facing views.
const STATUS_LABELS = {
